...
The output now includes a .csv file with the reference, warped, and
...
DefaultPath    = '/Users/pedrovallejo/OneDrive - University Of Cambridge/lag/microscopy work/color registration/test data 20190309/beads/test20190313';
...
tformCh_token  = {'_561','_488'}; % channel(s) to be transformed (e.g. {'_488','_561'})
...
for i=1:length(tformCh_token)
    ...
    % Previous code, now unused 2019-04-14
    %     if N_files > 1
    ...
    % Previous code, currently unused 2019-04-14
    ...
    results = cat(2,X,Y,X_d,Y_d,U,V,precision);
